 ...
 * 2014-10-13T23:22:01.606-03:00
 * Generated source version: 2.7.7.redhat-1
 * 
 */
@WebServiceClient(name = "WSMonitoreoService", 
                  wsdlLocation = "http://localhost:8080/Monitoreo/WSMonitoreo?wsdl",
...
public class WSMonitoreoService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/Monitoreo/WSMonitoreo?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WSMonitoreoService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/Monitoreo/WSMonitoreo?wsdl");
        }
        WSDL_LOCATION = url;
    }
